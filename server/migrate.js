...
const BIRDS_SEED = [
  ...
  },
  {
    ...
    desc_ar: 'الكونور الشمسي أجمل طيور الألوان. ألوانه البرتقالية والصفراء والخضراء مذهلة. شخصيته فرحة ومحبة للعب.',
  ...
  },
  {
    ...
    desc_ar: 'الرينغنيك أو ببغاء الرقبة الحلقية، طير أنيق بلونه الأخضر الزاهي. يتكلم جيداً ويحب التفاعل مع صاحبه.',
  ...
  },
  {
    ...
    desc_ar: 'الزرزور الزيبرا طير صغير وجميل بنقشاته المميزة. يغني بطريقة رائعة ويناسب الأشخاص الذين يريدون طيراً هادئاً.',
